...
import { OfficialCrudService } from '../../core/api/territorial-crud.services';
  ...
  template: `
    <section class="app-card">
      <ng-container *ngIf="collection$ | async as collection">
        <app-data-table [title]="'Funcionarios'" [rows]="collection.items" [columns]="columns"></app-data-table>
